export const messages = {
  ...
  Language: 'Idioma',
  Examples: 'Ejemplos',
  'Search examples': 'Buscar ejemplos',
  'No description provided.': 'Sin descripción.',
  'Components used': 'Componentes utilizados',
  Back: 'Volver',
  'No board': 'Sin placa',
  'Multiple boards': 'Múltiples placas',
  'New Project': 'Nuevo proyecto',
  'Create an empty board with project metadata.': 'Crea una placa vacía con nombre y descripción.',
  ...
  'Simulation notice intro': 'Las simulaciones intentan representar el mundo real y las placas simuladas con la mayor fidelidad posible, pero no sustituyen la experiencia física con componentes reales.',
  'Simulation notice memory': 'El entorno no valida desbordamiento de memoria, fragmentación de heap, bloqueos por firmware, watchdogs reales ni límites internos específicos de cada placa.',
  'Simulation notice electrical': 'Las reglas eléctricas ayudan a detectar problemas comunes, pero no modelan todos los efectos físicos, tolerancias, calentamiento, envejecimiento, ruido, rebote, falsos contactos o variaciones entre fabricantes.',
  'Simulation notice light': 'No se simulan picos ni variaciones rápidas de luz que puedan afectar sensores, alimentación o el funcionamiento del microcontrolador.',
  'Simulation notice magnetism': 'Tampoco se simulan interferencias electromagnéticas, campos magnéticos externos, acoplamiento inductivo/capacitivo ni problemas de layout físico.',
  'Simulation notice safety': 'Para proyectos con energía, motores, relés, baterías o cargas reales, valida el circuito físico con instrumentos y buenas prácticas de seguridad antes de montarlo.',
  'I understand': 'Estoy consciente',
  ...
  'Failed to share project': 'Error al compartir proyecto',
  Export: 'Exportar',
  Import: 'Importar',
  ...
  'Failed to load example': 'Error al cargar ejemplo',
  ...
  'We are compiling your code and it will run in a few moments.': 'Estamos compilando tu código y se ejecutará en unos instantes.',
  ...
  Undo: 'Deshacer',
  Lock: 'Bloquear',
  'Board locked': 'Placa bloqueada',
  'Board unlocked': 'Placa desbloqueada',
  Redo: 'Rehacer',
  Clear: 'Limpiar',
