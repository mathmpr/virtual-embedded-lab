export const messages = {
  ...
  Language: 'Idioma',
  Examples: 'Exemplos',
  'Search examples': 'Buscar exemplos',
  'No description provided.': 'Nenhuma descrição informada.',
  'Components used': 'Componentes utilizados',
  Back: 'Voltar',
  'No board': 'Sem placa',
  'Multiple boards': 'Múltiplas placas',
  'New Project': 'Novo projeto',
  'Create an empty board with project metadata.': 'Crie um board vazio com nome e descrição.',
  'Project name': 'Nome do projeto',
  Description: 'Descrição',
  Cancel: 'Cancelar',
  Create: 'Criar',
  'Untitled project': 'Projeto sem título',
  'Before you simulate': 'Antes de simular',
  'Simulation notice intro': 'As simulações tentam representar o mundo real e as placas simuladas da forma mais fiel possível, mas não substituem a experiência física com componentes reais.',
  'Simulation notice memory': 'O ambiente não valida estouro de memória, fragmentação de heap, travamentos por firmware, watchdogs reais ou limites internos específicos de cada placa.',
  'Simulation notice electrical': 'As regras elétricas ajudam a detectar problemas comuns, mas não modelam todos os efeitos físicos, tolerâncias, aquecimento, envelhecimento, ruído, bouncing, mau contato ou variações entre fabricantes.',
  'Simulation notice light': 'Não são simulados picos e variações rápidas de luz que podem afetar sensores, alimentação ou o funcionamento do microcontrolador.',
  'Simulation notice magnetism': 'Também não são simuladas interferências eletromagnéticas, campos magnéticos externos, acoplamento indutivo/capacitivo ou problemas de layout físico.',
  'Simulation notice safety': 'Para projetos com energia, motores, relés, baterias ou cargas reais, valide o circuito físico com instrumentos e boas práticas de segurança antes de montar.',
  'I understand': 'Estou ciente',
  ...
  'Failed to share project': 'Falha ao compartilhar projeto',
  Export: 'Exportar',
  Import: 'Importar',
  ...
  'Failed to load example': 'Falha ao carregar exemplo',
  ...
  'We are compiling your code and it will run in a few moments.': 'Estamos compilando seu código e ele será executado em alguns instantes.',
  ...
  Undo: 'Desfazer',
  Lock: 'Travar',
  'Board locked': 'Board travado',
  'Board unlocked': 'Board destravado',
  Redo: 'Refazer',
  Clear: 'Limpar',
